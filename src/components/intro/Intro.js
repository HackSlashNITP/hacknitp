    ...
    <div className="intro-parent-cont" id="about">
      <div className="intro-cont">
        <div className="intro-1" data-aos="fade-up">
          <h1 className="big-text">48</h1>
          <p className="text-small">hours</p>
        </div>
        <div className="intro-1" data-aos="fade-up">
          <h1 className="big-text">200+</h1>
          <p className="text-small">projects</p>
        </div>
        <div className="intro-1" data-aos="fade-up">
          <h1 className="big-text">400+</h1>
          <p className="text-small">teams</p>
        </div>
        <div className="intro-1" data-aos="fade-up">
          <h1 className="big-text">Online</h1>
      ...
      <div className="intro-cont-child" data-aos="fade-up">
        <div className="event-intro">
          <div className="event-title">
            ...
            <h3 className="event-big-text">WorkShops</h3>
          </div>
        ...
        <div className="event-intro">
          <div className="event-title">
            ...
            <h3 className="event-big-text">Webinars</h3>
          </div>
          <div className="event-text">
            <p className="event-small-text">
              resemble a link, use a button and change it with appropriate
        ...
        <div className="event-intro">
          <div className="event-title">
            ...
            <h3 className="event-big-text">Collaboration</h3>
          </div>
          <div className="event-text">
            <p className="event-small-text">
              resemble a link, use a button and change it with appropriate

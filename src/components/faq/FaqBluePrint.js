...
const FaqBluePrint = () => {
  ...
  for (let i = 0; i < num; i++) {
    document
      .querySelectorAll(".faq-blue-print")
    ...
    <div className="faq-blue-print">
      <div className="faq-flex">
        ...
        <div className="question">
          <h3 className="faq-ques">Who can apply for the hackathon?</h3>
        </div>
      </div>
      <div className="answer">
        <p className="faq-ans">
          Participants can take part only as a team. A team must comprise of at
          least 2 members and at.
        </p>
      </div>
    </div>
  )

...
const Timeline2 = () => {
    ...
    return (
      <>
        <div id="timeline" style={{ background: "#0f0000", color: 'white', fontFamily:"Poppins" }} className="pt-5">
        <h1 style={{textAlign: "center", fontSize: "45px"}} className="pb-5">Timeline</h1>
